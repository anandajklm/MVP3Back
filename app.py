...
from resources.coin import blp as CoinBlueprint
...
def create_app(db_url=None):
    ...
    app.config["API_TITLE"] = "Coins REST API"
    ...
    api.register_blueprint(ItemBlueprint, url_prefix="/api")
    api.register_blueprint(CoinBlueprint, url_prefix="/api")
